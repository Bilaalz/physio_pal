...
from process_frame_squat import ProcessFrame
from thresholds import get_thresholds_squats_beginner, get_thresholds_squats_pro
...
if mode == 'Beginner':
    thresholds = get_thresholds_squats_beginner()

elif mode == 'Pro':
    thresholds = get_thresholds_squats_pro()
