...
output_video_file = f'output_leg_raises_recorded.mp4'
...
if os.path.exists(output_video_file):
    with open(output_video_file, 'rb') as op_vid:
        download = download_button.download_button('Download Video', data = op_vid, file_name='output_leg_raises_recorded.mp4')
